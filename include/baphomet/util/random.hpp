...
template<typename T>
concept StringCompatible = IsAnyOf<T, std::string, std::u8string, std::u16string, std::u32string, std::wstring>;
...
baphomet::RGB rgb();
baphomet::RGB rgb(glm::ivec2 r_range, glm::ivec2 g_range, glm::ivec2 b_range);

baphomet::RGB rgba();
baphomet::RGB rgba(glm::ivec2 r_range, glm::ivec2 g_range, glm::ivec2 b_range, glm::ivec2 a_range);
