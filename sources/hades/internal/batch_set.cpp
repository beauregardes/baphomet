...
BatchSet::BatchSet(GladGLContext *ctx) : ctx_(ctx) {
  clear_batch_starts_();
}
...
void BatchSet::create_texture_batch(const std::string &name, const std::unique_ptr<gl::TextureUnit> &tex_unit) {
  tex_batches_[name] = std::make_unique<gl::TextureBatch>(ctx_, tex_unit);
  tex_batch_starts_[name] = 0;
}

void BatchSet::add_pixel(float x, float y, const hades::RGB &color) {
  if (!pixels)
...
void BatchSet::add_line(float x0, float y0, float x1, float y1, const hades::RGB &color, float cx, float cy, float angle) {
  if (!lines)
...
void BatchSet::add_tri(float x0, float y0, float x1, float y1, float x2, float y2, const hades::RGB &color, float cx, float cy, float angle) {
  if (!tris)
...
void BatchSet::add_rect(float x, float y, float w, float h, const hades::RGB &color, float cx, float cy, float angle) {
  if (!rects)
...
void BatchSet::add_oval(float x, float y, float x_radius, float y_radius, const hades::RGB &color, float cx, float cy, float angle) {
  if (!ovals)
...
void BatchSet::add_texture(const std::string &name, float x, float y, float w, float h, float tx, float ty, float tw, float th, float cx, float cy, float angle, const hades::RGB &color) {
